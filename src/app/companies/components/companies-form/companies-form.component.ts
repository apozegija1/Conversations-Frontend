...
export class CompaniesFormComponent extends BaseFormComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    if (this.id) {
      this.sink = this.companyApiService.getById(this.id)
